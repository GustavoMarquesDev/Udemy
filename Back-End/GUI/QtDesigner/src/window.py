...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sandButton = QPushButton(self.centralwidget)
        self.sandButton.setObjectName(u"sandButton")
        self.sandButton.setFont(font1)

        self.gridLayout_2.addWidget(self.sandButton, 0, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sandButton.setText(QCoreApplication.translate("MainWindow", u"Enviar", None))
    # retranslateUi
